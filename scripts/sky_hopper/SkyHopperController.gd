...
func _draw():
	...
	var sky_top = Color("142230")
	var sky_bottom = Color("234b6e")
	draw_rect(Rect2(0, 0, 360, 570), sky_bottom)
	draw_rect(Rect2(0, 0, 360, 240), sky_top)

	# 2. Distant Retro Hills
	var hill_col = Color("11281c")
	...
	var dirt_col = Color("5c3a21")
	var grass_col = Color("38761d")
	var dark_grass = Color("274e13")
